...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        changeStatusBarColor("#09779e") // Replace with your desired color code
    ...
    private fun showNextQuestion(selectedOperation: Int) {
        ...
        updateQuestionUI()
        startTimer()
        questionNumberTextView.text = "    Pregunta $currentQuestionNumber/50    "
    ...
    private fun startTimer() {
        ...
        timer = object : CountDownTimer(duration, interval) {
            ...
            override fun onFinish() {
                progressBar.progress = 100
                timerTextView.text = "¡Se acabó el tiempo!"
                endGame()
            }
        }.start()
    ...
    private fun generateRandomQuestion(operation: Int): Question {
        ...
        val num2 = when (operation) {
            ADDITION, SUBTRACTION, MULTIPLICATION -> random.nextInt(100) + 1 // Puedo ajustarlo si quero
            DIVISION -> generateRandomDivisor(num1)
            else -> random.nextInt(100) + 1 // Aquí también puedo elegir entre hacer
                                                  // un reto imposible o hacer que el reto sea
                                                 //fácil, por el rango de números-
        }
        ...
        when (operation) {
            ...
            RANDOM -> {
                // Aquí se selecciona una de los cuatro tipos de opraciones,
    ...
    private fun endGame() {
        ...
        Toast.makeText(this, "¡Perdistes! Tu puntaje: $score", Toast.LENGTH_SHORT).show()
        finalscoretv.setText("Puntaje: $score")
    ...
    fun onOptionSelected(view: View) {
        ...
        if (selectedOption == currentQuestion.correctOption) {
            ...
            Toast.makeText(this, "¡Mal Ahí! Fin del juego.", Toast.LENGTH_SHORT).show()
            endGame()
            return
        }
